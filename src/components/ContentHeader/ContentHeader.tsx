...
const styles = {
  h1: {
    ...
    heading: 'font-["Cormorant_Garamond"] text-[56px] leading-[64px] lg:text-[64px] lg:leading-[72px] font-light text-mill-text-primary text-center text-balance',
  ...
  h2: {
    ...
    heading: 'font-["Cormorant_Garamond"] text-[40px] leading-[48px] lg:text-[48px] lg:leading-[56px] font-normal text-mill-text-primary text-center text-balance',
    subtext: 'font-["Cormorant_Garamond"] text-[24px] leading-[32px] font-medium text-mill-text-secondary text-center',
    body: 'font-["Source_Sans_3"] text-[18px] leading-[28px] font-normal text-mill-text-primary',
  },
}
