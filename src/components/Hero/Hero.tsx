  ...
  return (
    <section className="relative w-full h-[650px] lg:h-[600px] overflow-hidden">
      ...
      />
        ...
        <div className="relative z-10 flex flex-col items-center justify-start gap-4 p-10 lg:py-14 lg:px-[171px] w-full h-full">        <h1 className="w-full font-['Cormorant_Garamond'] font-light text-[52px] leading-[1.231] lg:text-[64px] lg:leading-[1.125] text-center text-mill-background">
          {headline}
        </h1>
